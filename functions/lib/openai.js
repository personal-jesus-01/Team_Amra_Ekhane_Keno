...
exports.generateVisualRichSlide = exports.generateSlideRecommendations = exports.extractContentElements = exports.extractKeyPhrases = exports.modelContentTopics = exports.extractTabularData = exports.generateChartFromData = exports.applyAIRefinement = exports.summarizeOcrText = exports.analyzePresentation = exports.generatePresentationSlides = void 0;
const openai_1 = __importDefault(require("openai"));
// the newest OpenAI model is "gpt-4o" which was released May 13, 2024. do not change this unless explicitly requested by the user
const openai = new openai_1.default({ apiKey: process.env.OPENAI_API_KEY || 'sk-placeholder' });
/**
 ...
 */
async function generatePresentationSlides(prompt, numberOfSlides = 5, designVariants = 3, brandColors, style) {
    try {
...
exports.generatePresentationSlides = generatePresentationSlides;
/**
 ...
 */
async function analyzePresentation(presentationText) {
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4o",
            messages: [
...
exports.summarizeOcrText = summarizeOcrText;
/**
 ...
 */
async function applyAIRefinement(action, content, intensity = 'medium') {
    try {
...
exports.applyAIRefinement = applyAIRefinement;
/**
 ...
 */
async function generateChartFromData(tabularData, chartType = 'auto', title = '') {
...
exports.generateChartFromData = generateChartFromData;
/**
 ...
 */
async function extractTabularData(content) {
...
exports.extractTabularData = extractTabularData;
/**
 ...
 */
async function modelContentTopics(content) {
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4o",
            messages: [
...
exports.modelContentTopics = modelContentTopics;
/**
 ...
 */
async function extractKeyPhrases(content) {
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4o",
            messages: [
 ...
 */
async function extractContentElements(content) {
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4o",
            messages: [
...
exports.extractContentElements = extractContentElements;
/**
 ...
 */
async function generateSlideRecommendations(elements, slideCount = 5) {
    try {
...
exports.generateSlideRecommendations = generateSlideRecommendations;
/**
 ...
 */
async function generateVisualRichSlide(slideContent, slideType = 'content', includeStockImages = true) {
    var _a;
    ...
    try {
        ...
        if (slideContent.includes('|') || slideContent.includes('table') || slideContent.includes('csv')) {
            ...
            if (extractedData.tables && extractedData.tables.length > 0) {
                ...
                const chartConfig = await generateChartFromData(extractedData.tables[0], 'auto', ((_a = enhancedSlide.enhancedContent) === null || _a === void 0 ? void 0 : _a.split('\n')[0]) || 'Chart' // Use first line as title
                );
...
exports.generateVisualRichSlide = generateVisualRichSlide;
